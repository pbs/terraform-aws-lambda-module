...
```hcl
github.com/pbs/terraform-aws-lambda-module?ref=1.3.11
```
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_default_role"></a> [default\_role](#module\_default\_role) | github.com/pbs/terraform-aws-iam-role-module | 0.1.7 |
